      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8 bg-white p-6 rounded-xl shadow-lg">
          ...
          <div className="md:w-1/2 flex flex-col justify-between">
            {/* Title */}
            <h2
              className={`text-2xl font-bold text-gray-800 mb-2 ${styles.mainText}`}
            >
              {details?.title}
            </h2>
            ...
            {/* Add to Cart */}
            <button  onClick={()=>addProductToCart(details.id)} className="bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg shadow-md transition-all duration-300">
              Add To Cart
            </button>
          </div>
        </div>
